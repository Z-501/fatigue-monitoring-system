...
总体分层架构用于说明“有哪些系统角色”，业务总览图用于说明“这些角色如何围绕疲劳监测闭环协同”。因此 README 中同时保留总体架构图和业务链路图：前者帮助面试官快速建立系统边界，后者展示在线监测、离线采集、Agent 干预和历史回放之间的业务关系。
...
该展示仓库按照业务逻辑划分，而不是按照代码目录或技术栈简单堆叠。原因是：面试官更容易从业务链路中理解项目复杂度。
